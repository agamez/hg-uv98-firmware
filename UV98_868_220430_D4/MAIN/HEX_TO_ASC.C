...
// 
// void HEX_TO_ASC(int a) //Convert 2-byte HEX to ASC text, the first 0 is blanked, and the text is saved in ASC_BUF
// {
// unsigned char i;
// unsigned char zero;
// 
...
// ASC_BUF[5]=(a%10+0x30);
// 
// while(ASC_BUF[1]==&#39;0&#39;) //Blank the first 0
// {
// for(i=1;i<6;i++) 	{ ASC_BUF[i]=	ASC_BUF[i+1]; }
// }
// }
// 
// void HEX_TO_ASC(unsigned int a) //Convert 2-byte HEX to ASC text, the first leading 0 is blanked, and the text is saved in ASC_BUF
// {
// unsigned char i;
// 
// for(i=0;i<8;i++)	 {ASC_BUF[i]=0x00;}
...
// ASC_BUF[4]=(a%10+0x30);
// 
// while(ASC_BUF[0]==&#39;0&#39;) //Blank the first 0
// {
